...
export default async function NewOrderPage() {
  ...
  const [{ data: categories }, { data: items }, packages] = await Promise.all([
    supabase
    ...
    supabase
      ...
      .order("display_order"),
    fetchPackagesWithComposition(businessId, { activeOnly: true }),
  ]);
  ...
  return <OrderWizard businessId={businessId} categories={categoriesWithItems} packages={packages} />;
}
